    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
            Xem, tạo và quản lý tất cả bài tập lập trình trên hệ thống
          </p>
        </div>
        <Link
      ...
      {pagination && !loading && (
        <div className="text-sm text-gray-600 dark:text-gray-400">
          Hiển thị {exercises.length} / {pagination.total} bài tập
          {debouncedSearch && (
      ...
      {error && (
        <div className="rounded-lg border border-red-200 bg-red-50 p-4 dark:border-red-800 dark:bg-red-900/20">
          ...
          <button
            onClick={() => { setError(null); fetchExercises(); }}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl dark:bg-gray-800">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              ? Hành động này không thể hoàn tác và sẽ xóa tất cả test cases và bài nộp liên quan.
            </p>
